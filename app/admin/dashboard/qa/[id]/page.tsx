      ...
      try {
        ...
        if (data.success) {
          ...
          setFormData({
            ...
            category: data.qa.category || '',
            display_order: data.qa.display_order,
            published: data.qa.published,
          });
        }
      } catch (error) {
    ...
    return (
      <div className="text-center py-12">
        ...
        <Link
          ...
          className="text-[var(--gold)] hover:underline mt-4 inline-block"
        >
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-white/60">
          Modifiez les informations de cette question
        </p>
      </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-white mt-1">
                  {new Date(qaItem.created_at).toLocaleString('fr-FR')}
                </p>
              </div>
              <div>
                <span className="text-white/50">Modifié le:</span>
                <p className="text-white mt-1">
                  {new Date(qaItem.updated_at).toLocaleString('fr-FR')}
                </p>
              </div>
            </div>
          </div>
